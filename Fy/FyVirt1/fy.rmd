...
a. Tegn en graf med bolden højde som funktion af tiden.
   ...
   $$y(t) = -4.91 \cdot t^2 + 12 \ \frac{m}{s} \cdot t + 1.5 \ m$$
    ...
    ```{r, echo=FALSE}
   func = function(x){-4.91 * x^2 + 12 * x + 1.5}

   x = seq(0, 3, length = 100)
   y = sapply(x, FUN=func)

   plot(x, y, type='l', ylab = "Sted(meter)", xlab = "tid(sekunder)")
    ```
...
a. Tegn banekurven. Brug evt. et matematikprogram eller en grafregner.
   ...
   Og plotter x og y
    ...
    x = sapply(t, FUN = function(t){9.83*t})
    y = sapply(t, FUN = function(t){-4.91*t*t+6.88*t})
